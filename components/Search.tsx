...
const Search: React.FC<Props> = ({ search, setSearch }) => {
  return (
    <div
      className="max-w-[1150px] bg-[#1a1a1a] rounded-full overflow-hidden border-2 border-[#333]
  py-1.5 pl-5 pr-8 flex items-center"
    >
      ...
      <input
        ...
        className="bg-transparent text-white border-none lg:w-full focus:ring-0 outline-none placeholder:text-[#fafafa] text-xsp"
        placeholder="Search..."
      />
